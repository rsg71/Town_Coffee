            ...
            <Container>
                ...
                <Row>
                    ...
                    <Col sm={6} style={styles.alignCenter}>
                        <img src={process.env.PUBLIC_URL+"/imgs/logo.png"} alt="coffee cup" style={styles.townCoffeeLogo}></img>
                    </Col>
                </Row>
                <br />
                <br />
                ...
                <Row style={styles.three}>
                            <Col sm={4}>
                                <h3>Great Coffee <i class="far fa-check-circle"></i></h3>
                            </Col>
                            <Col sm={4}>
                                <h3>Fair Wages <i class="fas fa-hand-holding-usd"></i></h3>
                            </Col>
                            <Col sm={4}>
                                <h3>Earth friendly <i class="fas fa-globe-americas"></i></h3>
                            </Col>
                        </Row>
                ...
                <Row>
                    <Col sm={6} style={styles.center}>
                        <img src={process.env.PUBLIC_URL+"/imgs/b-corp-logo.png"} alt="b corp logo"></img>
                    </Col>
                    <Col sm={6} style={styles.backgroundStyleLight}>
