...
function IndividualCoffee2({ addToCart }) {
    ...
    const [coffeeItem, setCoffeeItem] = useState("Planet")
        ...
        <>
            ...
            <BreadCrumbsCoffee name={coffeeItem}/>
                ...
                <Row>
                    ...
                    <Col lg={6} sm={12}>
                        <h2><strong>Planet, 16 oz.</strong></h2>
                        <h4>${itemPrice/100}</h4>
                        <h6><span className={status==="Available"? "coffeeStatusAvail" : "coffeeStatusUnavail"}>{status}</span></h6>
                        <br/>
                        <p>Good for the planet and good for your body. Get a taste of this dark roast Mexican bean. We're so confident in our coffee that if you aren't fully satisfied, keep the bag and we'll refund your purchase. Yep. It's that good.</p>
                        <br/>
                        ...
                        <Form>
                            <Form.Row className="align-items-center">
                                ...
                                {status === "Available"?
                                    ...
                                    <Button className="cartButton individualCoffeeButtons" size="sm" style={{marginTop: "10px"}} disabled>Sold out</Button>}
                        ...
                        <Row>
                            ...
                            <label><strong>+ Details</strong></label>
                                    <ul>
                                    <li>Dark roast blend</li>
                                    </ul>

                                <label><strong>+ Flavor Profile:</strong></label>
                                <ul>
                                    <li>Bolder flavor</li>
                                    <li>Our darkest, boldest roast</li>
